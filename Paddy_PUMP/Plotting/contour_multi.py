...
if rgnt == 'MOP':
    i_max = -0.02998561984105308
    i_min = -10000001.5
if rgnt == 'TMB':
    i_max = -0.09847458217510541
    i_min = -10000001.5
if rgnt == 'TDMAB':
    i_max = -0.04462382966821776
    i_min = -1.5895597189866608
...
cs = plt.contourf(y,x,z, levels = 100, vmin=0.0, vmax=1.0, cmap='RdBu', extend='neither')#not bad
...
plt.savefig("Plotting/{0}_{1}.png".format(rgnt,itt_nbr),dpi=300)