...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 27 15:26:32 2021
...
elemental_composition = 'C7H9O2S1' #'C4H7O2N1' #sys.argv[1]
...
def find_reagents_ml_based(lst_of_lst):
    ...
    if (('S' in elements and numbers[elements.index('S')] >= 1) and ('O' in elements and numbers[elements.index('O')] >= 1) and rdbe >= 1.5) or (('N' in elements and numbers[elements.index('N')] >= 1) and ('O' in elements and numbers[elements.index('O')] >= 1) and rdbe >= 0 and rdbe < 4) or (('O' in elements and numbers[elements.index('O')] >= 1) and rdbe >= 2 and rdbe < 4):
        reagent = reagent = reagents[0]
        print('\n',reagent, '\n') 
        
    if ('O' in elements and numbers[elements.index('O')] >= 1) or (('O' in elements and numbers[elements.index('O')] >= 1 and rdbe >= 0.5) and ('N' in elements and numbers[elements.index('N')] >= 1)) or (('O' in elements and numbers[elements.index('O')] >= 1) and ('N' in elements and numbers[elements.index('N')] == 0)) or ('N' in elements and numbers[elements.index('N')] == 0 and 'O' in elements and numbers[elements.index('O')] == 0 and rdbe >= 3.5) or ( 'N' in elements and numbers[elements.index('N')] == 0 and rdbe >= 0.5) or ('N' in elements and numbers[elements.index('N')] == 0 and 'O' in elements and numbers[elements.index('O')] == 0 and 'S' in elements and rdbe >= 0.5):
        reagent = reagent = reagents[1]
        print('\n',reagent, '\n') 
    
    if ('S' in elements and numbers[elements.index('S')] >= 1 and rdbe >= 0.5 and rdbe < 2) or ('N' in elements and numbers[elements.index('N')] >= 1 and rdbe >= 0.5) or ('S' in elements and numbers[elements.index('S')] >= 1 and  rdbe == 1) or ('O' in elements and numbers[elements.index('O')] >= 1 and 'N' in elements and numbers[elements.index('N')] >= 1):
        reagent = reagent = reagents[2]
        print('\n',reagent, '\n')
